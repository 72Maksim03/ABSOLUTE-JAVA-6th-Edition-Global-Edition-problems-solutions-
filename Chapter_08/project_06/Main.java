/**
 * Flesh out Programming Project 8.5. Give new definitions for the various constructors and methods center, draw, and erase of the class Figure; draw and erase
 ...
 * on the screen in the desired shape. Use the character '*' for all the character graphics. That way, the draw methods actually draw figures on the screen by placing the
...
public class Main {
    public static void main(String[] args) {
        Figure figure1 = new Rectangle(2, 3, 10, 5);
        Figure figure2 = new Triangle(3, 2, 6);
