/**
 * Write a class that keeps track of the top five high scores that could be used for a
...
public class Main {
    public static void main(String[] args) {
        ...
        printArr(tp.getTopNames(), tp.getTopScores());
        tp.playerScore("Player 5", 10);
        printArr(tp.getTopNames(), tp.getTopScores());
        tp.setPlayer(4, "Player 3");
        tp.setScores(4, 1500);
        printArr(tp.getTopNames(), tp.getTopScores());
    }

    public static void printArr(String[] names, int[] arr){
