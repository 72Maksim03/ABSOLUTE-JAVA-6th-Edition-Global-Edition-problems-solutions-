...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Do you want to create a custom sized world? [y]/[n]");
        ...
        System.out.println("Enter number of predators and preys");
        int numOfPredator = sc.nextInt();
        int numOfPrey = sc.nextInt();

        simulation.fill(numOfPrey, numOfPredator);
